...
#define outpw(port,value)     writel(value,port)
...
typedef s64               INT64;    ///< Define 64-bit signed data type
typedef u64               UINT64;   ///< Define 64-bit unsigned data type
